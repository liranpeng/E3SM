...
extern "C" void pam_driver() {
  ...
  bool use_ecpp      = coupler.get_option<bool>("use_ecpp");
  ...
  // ECPP initialization
  if (use_ecpp) { pam_ecpp_init(coupler); }
  //------------------------------------------------------------------------------------------------
  //------------------------------------------------------------------------------------------------
  //------------------------------------------------------------------------------------------------
...
*/
  ...
  // copy aggregated ECPP statistics to host to drive plume/chem calculations
  if (use_ecpp) { pam_ecpp_copy_to_host(coupler); }
