...
subroutine crm_history_init(species_class)
   ...
   call addfld('MMF_PTENDQ_LPTR15   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR8   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR9   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR10   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR11   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR12   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR13   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR14   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR20   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR16   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR17   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR18   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR19   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR28   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR21   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR22   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR23   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR24   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR25   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR26   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR27   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR32   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR29   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR30   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_PTENDQ_LPTR31   ',(/'lev'/), 'A','#/kg/s','Droplet number source')

   call addfld('MMF_STATEBF_LPTR15   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR8   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR9   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR10   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR11   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR12   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR13   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR14   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR20   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR16   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR17   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR18   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR19   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR28   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR21   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR22   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR23   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR24   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR25   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR26   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR27   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR32   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR29   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR30   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEBF_LPTR31   ',(/'lev'/), 'A','#/kg/s','Droplet number source')

   call addfld('MMF_STATEAF_LPTR15   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR8   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR9   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR10   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR11   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR12   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR13   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR14   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR20   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR16   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR17   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR18   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR19   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR28   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR21   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR22   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR23   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR24   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR25   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR26   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR27   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR32   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR29   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR30   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
   call addfld('MMF_STATEAF_LPTR31   ',(/'lev'/), 'A','#/kg/s','Droplet number source')
